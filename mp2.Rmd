...
From the graph below we see that in the states of ___ & ___ most contributions were given to the incumbent in comparison to their challenger and open seat. 
...
The results are inconsistent with the research that we found thus far.However, it is important to remember that we have only focused on  Amongst the three committees that we have looked at so far only NRA had donated more money to candidates who were running for an Open office. Also In
