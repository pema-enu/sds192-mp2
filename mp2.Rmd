...
```
```{r}
#group_by committee and transaction type to find total contributions made in 2012 by each committee
cmte_ordered_2012 <- committee_trans_2012 %>%
  group_by(cmte_id)
head(cmte_ordered_2012)
```
